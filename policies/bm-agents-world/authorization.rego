...
decision := {
  ...
  "riskLevel": risk,
  "approvalMode": mode,
  "reason": sprintf("Production-scoped external write remains governed at %s.", [risk])
} if {
  input.context.environment == "prod"
  input.definition.actionClass == "external-write"
  input.definition.productionMutation == false
