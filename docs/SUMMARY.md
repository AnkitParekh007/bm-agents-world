...
## Getting started
* [Application overview](getting-started/overview.md)
...
* [Frontend, routing, and state](architecture/frontend.md)
* [Frontend component system](frontend/components.md)
* [Agent packs and CopilotKit](architecture/agents-and-packs.md)
...
* [Authenticated browser testing](features/browser-testing.md)
* [Jira defect workflow](features/jira-defects.md)
...
* [Build and CI](development/build-and-ci.md)
...
* [Maintaining these docs](reference/maintaining-docs.md)
